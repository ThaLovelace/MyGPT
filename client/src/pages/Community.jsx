        ...
        <div className='flex flex-wrap max-sm:justify-center gap-5'>
          {images.map((item, index) => (
            <a
              ...
              className='relative group block rounded-lg overflow-hidden border border-gray-200 dark:border-purple-700 shadow-sm hover:shadow-md transition duration-300'
            >
              <img
                src={item.imageUrl}
                alt=''
                className='w-full h-40 md:h-62 2xl:h-62 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out'
              />
